...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { id: 'Subscription', icon: <Image size={20} />, label: 'Influencer Subscriptions' },
    { id: 'userSubscription', icon: <Image size={20} />, label: 'User Subscriptions' },
    ...
    >
      ...
      <div className={`flex items-center p-4 ${collapsed ? 'justify-center' : 'justify-between'}`}>
        ...
        {collapsed && (
          ...
          <span className="text-white font-bold text-sm w-7 cent">BB</span>
          </div>
        )}
        <button 
