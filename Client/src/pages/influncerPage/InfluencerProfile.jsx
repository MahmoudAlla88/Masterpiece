...
const InfluencerProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    name: "Sarah Johnson",
    location: "Dubai, UAE",
    bio: "Lifestyle and fashion content creator with a passion for sustainable brands. I showcase the best products that align with conscious living and modern style.",
    profileImage: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTD2PmKtswxnRlPBc1kBmglpvWgIz3SnfWtBQ&s",
    coverImage: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTD2PmKtswxnRlPBc1kBmglpvWgIz3SnfWtBQ&s",
    stats: {
      followers: "245K",
      engagementRate: "3.8%",
      totalPosts: "862",
    ...
    socialLinks: [
      ...
      { platform: "tiktok", url: "https://tiktok.com/@sarahjohnson", followers: "95K" },
    ...
    audienceDemo: {
      ...
      ageGroups: "18-24 (45%), 25-34 (38%), 35+ (17%)",
      topLocations: "UAE, Saudi Arabia, Kuwait, Qatar"
    },
    previousCampaigns: [
      { brand: "EcoStyle", description: "Sustainable fashion collection launch", date: "Jan 2025" },
      { brand: "PureBeauty", description: "Organic skincare promotion", date: "Nov 2024" }
    ]
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div 
        ...
        style={{backgroundImage: `url(${profileData.coverImage})`, backgroundSize: 'cover', backgroundPosition: 'center'}}
      >
        {/* Profile Picture */}
      ...
      <div className="container mx-auto px-4 pt-20 pb-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
          <div className="bg-white p-4 rounded-lg shadow-sm">
            ...
            <p className="text-2xl font-bold text-purple-500">{profileData.stats.followers}</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <p className="text-sm text-gray-500">Engagement Rate</p>
            <p className="text-2xl font-bold text-purple-500">{profileData.stats.engagementRate}</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <p className="text-sm text-gray-500">Total Posts</p>
            <p className="text-2xl font-bold text-purple-500">{profileData.stats.totalPosts}</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-sm">
            <p className="text-sm text-gray-500">Avg. Likes</p>
            <p className="text-2xl font-bold text-purple-500">{profileData.stats.avgLikes}</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Content Categories</h3>
                ...
                <div className="space-y-4">
                  {profileData.socialLinks.map((social, index) => (
                    ...
                    >
                      ...
                      <span className="text-purple-500 font-medium">{social.followers}</span>
                    </a>
                  ))}
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              {[1, 2, 3, 4, 5, 6].map(item => (
                <div key={item} className="aspect-square rounded-lg overflow-hidden bg-gray-200 relative">
                  <img 
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-lg font-medium">{profileData.audienceDemo.gender}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="text-gray-500 text-sm mb-2">Age Groups</h3>
                <p className="text-lg font-medium">{profileData.audienceDemo.ageGroups}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="text-gray-500 text-sm mb-2">Top Locations</h3>
                <p className="text-lg font-medium">{profileData.audienceDemo.topLocations}</p>
              </div>
            </div>
            
            <div className="mt-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Engagement by Time</h3>
        ...
        {activeTab === 'campaigns' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">Previous Campaigns</h2>
